...
public class OutPutBinary {
    ...
    public List<Byte> generate() {
        ...
        for(int i=0;i<globals.size();i++){
            ...
            List<Byte> global_is_const=int2bytes(1,(global.isIs_const() ? 1:0));
        ...
        for(int i=0;i<functionTables.size();i++){
            ...
            //ret_slots
            List<Byte> ret_slots=int2bytes(4,functionTable.getReturnSoltNum());
            ...
            //loc_slots;
            List<Byte> loc_slots=int2bytes(4,functionTable.getVarSoltNum());
